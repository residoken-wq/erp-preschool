...
gates và threat-model baseline đã hoàn tất; Gate G0 chưa PASS do chưa có named
owners/pilot scope, Security/Privacy sign-off và remote clean-checkout CI evidence.
